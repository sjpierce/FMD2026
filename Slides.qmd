...
## Example Data Set: Variable-Level Missingness 
...
:::{.notes}
You should also examine variable-level missingness. A variable may be a 
single-item construct (like age in this dataset), 

or it may be an item used to 
define 

Here, age is a single-item 
construct
single-item construct

can be either 
an item or a construct. 
:::
