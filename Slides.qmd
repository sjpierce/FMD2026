...
matters, but each study is unique. The nature and extent of the missing data 
issues you face will vary across studies. We can't make good choices about what
to do about missing data until we thoroughly understand the nature and scope of
the problem on a given study. That means the next logical question is "how can we 
diagnose the missing data issues for a given study?" 

I'm going to introduce a broad framework that will help you plan the diagnostic
work, then cover some additional concepts that pertain to describing the
...
* Recommends a structured approach.
* Principles are applicable beyond observational studies.

::: {.notes}
You cannot plan a proper diagnosis process without first planning the analysis 
you intend to run. 
:::

## TARMOS Step 1: Plan the Analysis

* Identify the analysis model you would use if there were no missing data.
...
* Conduct analysis, acknowledge & justify deviations from the plan.
