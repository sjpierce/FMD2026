...
## Example Data Set: Size & Missingness Overview
...
Some statistical software packages have functions that make it very easy to 
get this sort of overview. 

If you have longitudinal data, I would start 
:::
...
LvW <- data.frame(format = c("Wide", "Long"), 
                  cases = c("Persons with any MD (across variables & times)", 
                            "Person-periods with any MD at specific times (across variables)"),
...
This table shows some key points about how to interpret the kind of missingness 
overview I showed you on the last slide. 

I recommend that you run such overviews for both long and wide versions of 
