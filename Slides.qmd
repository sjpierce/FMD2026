...
::: {.notes}
Reporting on the reasons why participants drop out, skip data collection events, 
or have other missing data becomes much easier when you have a systematic 
tracking system that records: 
...
::: {.notes}
The CONSORT 2025 statement requires disclosing missing data handling. 
