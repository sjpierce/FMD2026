...
- [`Slides.qmd`](https://github.com/sjpierce/FMD2026/blob/main/Slides.qmd)  
...
- `FMD2026/`: This is the root folder for the repository.
  ...
  - `FMD2026.Rproj`: This is an RStudio project file. It contains some
