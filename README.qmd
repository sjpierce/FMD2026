...
For the link below, you will land on a GitHub page with a *Download raw file* 
button in the upper right corner of the screen. Its icon looks like an arrow
pointing down into a tray. It is just to the left of the pencil icon. Use that
to download each file to your computer, then open it with a web browser.
